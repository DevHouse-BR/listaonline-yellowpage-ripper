...
/*
     FILE ARCHIVED ON 22:11:19 jan 29, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:55:01 set 8, 2016.
     JAVASCRIPT APPENDED BY WAYBACK MACHINE, COPYRIGHT INTERNET ARCHIVE.

     ALL OTHER CONTENT MAY ALSO BE PROTECTED BY COPYRIGHT (17 U.S.C.
     SECTION 108(a)(3)).
*/
//hbx.js,HBX1.4,COPYRIGHT 1997-2005 WEBSIDESTORY,INC. ALL RIGHTS RESERVED. U.S.PATENT No.6,393,479B1 & 6,766,370. INFO:/web/20110129221119/http://websidestory.com/privacy
var _vjs="HBX0141.01u";
...
function _B(){return 0}function _GP(){return window.location.protocol=="https:"?"https://":"http://"}
...
f++){g=_IP(e[f],"=");_SV(g[0],g[1])}}_TV();if(c!=""){_SV("hec",0);setTimeout("window.location.href='"+c+"'",500)}}
...
function _LE(a,b,c,d,e,f,g,h,i,j,k,l){b="([0-9A-Za-z\\-]*\\.)",c=window.location.hostname,d=a.href,h='',i='';eval("_f=/"+b+"*"+b+"/");if(_DD(_f)){_f.exec(c);	
...
function _PO(a,b,c,d,e,f,g){d=window.location,e=d.pathname,f=_IS(e,_IF(e,"/")+1),g=document.title;if(a&&b==c){return(_pndef=="title"&&g!=""&&g!=d&&
...
function _H(a,b,c){if(!a)a=c;if(_I5||_N6){eval("try{_vv=_G(window.location.search,'"+a+"','"+b+"',1)}"+__c+"{}")}else{_vv=_G(window.location.search,a,b,1)}return unescape(_vv)}
function _I(a,b,c,d){__f=_IS(a,_II(a,"?"));if(b){if(_I5||_N6){eval("try{_hra=_G(__f,_hqsr,_hra,0)}"+__c+"{}")}else{_hra=_G(__f,_hqsr,_hra,0)}};
if(c&&!_hra){if(_I5||_N6){eval("try{_hra=_G(window.location.search,_hqsp,_hra,1)}"+__c+"{}")}else{_hra=_G(window.location.search,_hqsp,_hra,1)}};
if(d&&!_hra)_hra=d;return _hra}function _J(a,b){return(_II(a,"CP=")<0)?"null":_IS(a,_II(a,"CP=")+3,(b=="*")?_II(a,"*"):null)}
...
_hck="*; path=/; "+(_D("cpd")&&_D("cpd")!=""?(" domain=."+_D("cpd")+"; "):"")+_ex,_N6=(_bnN&&_bv>4),_I5=((_II(navigator.userAgent,'MSIE 5')>-1)||
(_II(navigator.userAgent,'MSIE 6')>-1)),_ss="na",_sc="na",_sv=11,_cy="u",_hp="u",_tp=_D("ptc");if(_N6||_I5)
eval("try{_tls=top.location.search}catch(_e){}")
...
if(window.location.search&&_TL(_cp)=="null")_cp=_J(window.location.search,"x");if(_II(document.cookie,"CP=")>-1){
...
if(document.body&&document.body.addBehavior){document.body.addBehavior("#default#homePage");_hp=document.body.isHomePage(window.location.href)?"y":"n";
